...
do
	echo "Parsing ${GGENE}"
	GOLR_QUERY=$(echo "http://golr-aux.geneontology.io/solr/select?qt=standard&?fq=document_category:%22annotation%22&q=*:*&fq=bioentity_label:%22${GGENE}%22&fq:taxon=%22NCBITaxon%3A9606%22&fq=evidence_type:%22IDA%22&&wt=json&indent=on&fl=${FL_STRING}")
	echo ${GOLR_QUERY}
